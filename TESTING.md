...
npm run test:conformance  # source check and all 309 jsonspecs/spec RC.7 fixtures
...
The package test suite separately verifies that an otherwise valid RC.6 snapshot is
rejected with `UNSUPPORTED_SPEC_VERSION`; RC.6 fixtures are not part of the normative
RC.7 corpus.

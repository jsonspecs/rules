...
try {
  ...
  fs.writeFileSync(path.join(consumer, "smoke.cjs"), `
    ...
    const snapshot = {format:"jsonspecs-snapshot",formatVersion:2,specVersion:"1.0.0-rc.7",exports:["p"],artifacts:{p:{type:"pipeline",steps:["r"]},r:{type:"rule",operator:"not_empty",field:"x",issue:{level:"ERROR",code:"X",message:"required"}}}};

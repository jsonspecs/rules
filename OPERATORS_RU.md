...
[спецификации поведения](https://github.com/jsonspecs/spec/blob/f474b5924b55e20e61a8760f0ea752d630ccdf69/SPEC_RU.md).
...
встроенного `any_filled`. На уровнях конфигурации, `inputs` и непосредственного
объекта `params` схема должна перечислять конечный набор имён. `patternProperties`
на этих уровнях запрещён.
